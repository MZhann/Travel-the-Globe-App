          ...
          <div className={`flex gap-3 ${isFullscreen ? '' : 'flex-col'}`}>
            ...
            {onShareGlobe && (
              <button
                ...
                className={`flex items-center justify-center gap-2 rounded-lg border border-blue-500/30 bg-blue-600/20 py-2 text-sm text-blue-400 transition hover:bg-blue-600/30 ${
